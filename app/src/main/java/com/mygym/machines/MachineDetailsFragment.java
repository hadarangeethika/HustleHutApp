...
import com.mygym.utils.RealPathUtil;
            ...
            public void onGlobalLayout() {
                ...
                if (mCurrentPhotoPath != null && !mCurrentPhotoPath.isEmpty()) {
                    ...
                    if (mMachine.getType() == DAOMachine.TYPE_FONTE || mMachine.getType() == DAOMachine.TYPE_STATIC) {
                        imgUtil.getView().setImageDrawable(getActivity().getResources().getDrawable(R.drawable.ic_exercise));
                    } else {
